...
enum Stat {
	...
	DOUBLE_STRIKE,  ## % шанса ударить дважды (реликвии)
	KILL_HEAL,      ## % здоровья за каждое убийство (реликвии)
}
...
const ICON_NAMES := [
	...
	"rest_speed", "need_decay", "training_speed", "army_power", "double_strike", "kill_heal",
]
...
const STAT_TITLES := [
	...
	"Кровожадность", "Сон воина", "Выносливость", "Муштра", "Командование", "Двойной удар", "Жатва",
]
...
const STAT_LABELS := [
	...
	"шанса двойного удара", "здоровья за убийство",
]
